...
"""
This script loads LiteBIRD TOAST data and makes a map.
"""
...
def parse_config(operators, templates, comm):
    ...
    """
    # Argument parsing
    parser = argparse.ArgumentParser(description="LiteBIRD Mapmaking")
...
def main():
    ...
    # Load the data
    data = workflow.load_data(job, args, comm)
